process GFASTATS {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/gfastats:1.3.9--hdcf5f25_0':
        'biocontainers/gfastats:1.3.9--hdcf5f25_0' }"
    ...
    def out_arg = out_fmt ? "--out-format ${prefix}.${out_fmt}.gz" : ""
